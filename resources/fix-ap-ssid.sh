#!/bin/bash
# Quick fix to enable setup-wlan0_ap.service on existing FabMo systems
...
echo ""
echo "This script will enable setup-wlan0_ap.service which updates the"
...
if [ ! -f "/fabmo/files/network_conf_fabmo/setup-wlan0_ap.service" ]; then
    ...
    echo "   Expected: /fabmo/files/network_conf_fabmo/setup-wlan0_ap.service"
    echo ""
...
echo ""
echo "Enabling setup-wlan0_ap.service..."
sudo systemctl enable setup-wlan0_ap.service

echo ""
echo "Starting setup-wlan0_ap.service..."
...
echo ""
echo "Service status:"
sudo systemctl status setup-wlan0_ap.service --no-pager -l
...
echo "  sudo journalctl -u setup-wlan0_ap.service -f"
echo ""
